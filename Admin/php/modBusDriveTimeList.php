...
<?php
    ...
    mysqli_close($conn);
 ?>
 <form method="post" action="../php/modBusDrive.php">
   <h2>수정을 원하는 운행 날짜를 입력하세요.<h2><br>
   ...
   <br><br><h2>수정을 원하는 버스 출발 시간을 입력해주세요.<h2><br>
   ...
   <div class="container-width">
     <input type="text" name="src_sec" placeholder="초 (sec)" required=''>
   </div>
   <br><br><br><br>
   <h2>변경할 버스 출발 시간을 입력해주세요.<h2><br>
   <div class="container-width">
   ...
   <br><h2>변경할 버스 도착 시간을 입력해주세요.<h2><br>
   <div class="container-width">
   <input type="text" name="new_dest_hour" placeholder="시 (hour)" required=''></div> :
   <div class="container-width">
   <input type="text" name="new_dest_min" placeholder="분 (min)" required=''></div> :
   <div class="container-width">
   <input type="text" name="new_dest_sec" placeholder="초 (sec)" required=''></div>
   <br><br>
   <button type="submit" style="font-family:'Do Hyeon'; font-size:40px;" name="modBusdrive" required=''>수정</button>
   <br><br><br>
