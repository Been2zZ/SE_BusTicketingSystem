...
<?php
    ...
    mysqli_close($conn);
 ?>
 <form method="post" action="../php/delBusDrive.php">
   <h2>삭제를 원하는 운행 날짜를 입력하세요.<h2><br>
   ...
   <br><br><h2>삭제를 원하는 버스 출발 시간을 입력해주세요.<h2><br>
   ...
   <br><br>
   <button type="submit" style="font-family:'Do Hyeon'; font-size:40px;" name="modBusdrive" required=''>삭제</button>
   <br><br><br>
