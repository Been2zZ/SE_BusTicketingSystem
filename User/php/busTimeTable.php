<!DOCTYPE html>
 ...
 <?php
     ...
     if ($day < $row_check[0]) {
       // 현재 날짜보다 이전
       print "<script>alert('지난 날짜에 관한 시간표는 조회가 불가능 합니다.')</script>";
     ...
     while ($row = mysqli_fetch_array($result)) {
       // code...
       $query2 = "select day,srcTime,destTime from BUS_DRIVE_DB where busId='$row[0]' and day='$day' order by srcTime";
       $result2 = mysqli_query($conn, $query2);
