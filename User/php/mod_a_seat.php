...
<?php
  ...
  echo "<h2>이미 예약이 완료된 좌석의 목록입니다.<h2><section>
  <div></div>
...
?>
    ...
    <form method="post" action="mod_ticketing_seat.php">
      <img src="a.seat.png" width='300px' height='400px'><br><br>
      <input type="text" name="seatNum" placeholder="좌석 번호를 입력해주세요." required=''>
      <button type="submit" style="font-family:'Do Hyeon'; font-size:40px;" name="a_seat">선택</button>
      <br><br>
